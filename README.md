...
This repository documents a series of hands-on experiments using the **STM32F446RE Nucleo Board**, covering everything from foundational bare-metal GPIO programming to real-time operating system implementation using **FreeRTOS**, **STM32CubeIDE**, and **STM32CubeMX**.
...
- Experiments 1 through 5 follow a **bare-metal, HAL-based** approach using polling loops and software delays.
